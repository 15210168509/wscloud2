...
layui.use(['form', 'laydate','autocomplete','laypage','layer'], function(){
    ...
    var data = { companyId:currentCompanyId.val(),startTime: 'null', endTime: 'null',name:"null",phone:"null",pageNo:1,pageSize:10,code:"null",vehicleNo:vehicleNo.val().length>0 ? vehicleNo.val() : "null", deviceNo:deviceNo.val().length>0 ? deviceNo.val() : "null"};
    ...
    function setLists() {
        ...
        $.ajax({
            type: "post",
            url: baseUrl+"/Company/ajaxGetBehaviorLists",
            data: data,
            dataType: "json",
