                    ...
                    <div class="layui-form layui-form-pane" style=" padding: 5px;">
                        <div class="layui-col-xs6 layui-col-sm6 layui-col-md4">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="username" id="startTime" class="layui-input" placeholder="开始时间" readonly value="<?php echo (date('Y-m-d',$where_startTime )); ?>">
                            </div>
                        </div>
                        <div class="layui-col-xs6 layui-col-sm6 layui-col-md4">
                            <label class="layui-form-label">结束时间</label>
                            <div class="layui-input-inline">
                                <input type="text" name="username" id="endTime" class="layui-input" placeholder="结束时间" readonly value="<?php echo (date('Y-m-d',$where_endTime )); ?>">
                            </div>
                        </div>
                        <div class="layui-col-xs6 layui-col-sm6 layui-col-md4">
