...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-card">
        <div class="layui-card-body">
            ...
            <form class="layui-form layui-form-pane" action="javascript:;" method="post" id="add_groups">

                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label"style="width: 90px">组名称</label>
                        <div class="layui-input-inline">
                            <input type="text" name="name" lay-verify="name" placeholder="组名称" maxlength="7"  autocomplete="off" class="layui-input">
                        </div>
                    </div>
                </div>
                ...
                <!--<div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label" style="width: 90px">分组类型</label>
                        <div class="layui-input-inline">
