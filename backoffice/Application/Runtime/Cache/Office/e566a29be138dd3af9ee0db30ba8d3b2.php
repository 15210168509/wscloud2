...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <input type="hidden" id="serialNo" value="<?php echo ($serialNo); ?>">
            <input type="hidden" id="deviceTopic" value="<?php echo ($deviceTopic); ?>">
            <form class="layui-form" action="javascript:;" method="" id="">

                <div class="layui-form-item">
                    <label class="layui-form-label">低头角度</label>
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" name="60" value="" placeholder="请输入10—30的整数" lay-verify="60">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" name="80" value="" placeholder="请输入15—35的整数" lay-verify="80">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" name="90" value="" placeholder="请输入15—35的整数" lay-verify="90">
                    </div>
                </div>
