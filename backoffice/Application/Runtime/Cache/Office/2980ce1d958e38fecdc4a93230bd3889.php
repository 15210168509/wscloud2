        ...
        <div class="layui-col-md12">
            <div class="layui-row grid-demo">
                ...
                <div class="layui-row layui-col-space15">
                    <div class="layui-col-md12">
                        <div class="layui-form layui-form-pane" style=" padding: 5px;background-color: #fff;">
                            <div class="layui-form-item">

                                <div class="layui-inline">
                                    <label class="layui-form-label">司机</label>
                                    <div class="layui-input-inline">
                                        <input class="layui-input" readonly="readonly" value="<?php echo ($driverInfo['name']); ?>">
                                    </div>
                                </div>
                                <div class="layui-inline">
                                    <label class="layui-form-label">手机号</label>
                                    <div class="layui-input-inline">
                                        <input class="layui-input" readonly="readonly" value="<?php echo ($driverInfo['phone']); ?>">
                                    </div>
                                </div>
                    ...
                    <div class="layui-col-md6">
                        <div class="layui-card">
                            <div class="layui-card-body">
                                <div id="tired_no" class="" style="height: 340px;"></div>
                            </div>
                        </div>

                        <div class="layui-card">
                            <div class="layui-card-body">
                                <div id="tired_type" class="" style="height: 340px;"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="layui-col-md6">
                        <div class="layui-card">
                            <div class="layui-card-body">
                                <div id="tired_no_realtime" class="" style="height: 340px;"></div>
                            </div>
                        </div>

                        <div class="layui-card">
                            <div class="layui-card-body">
                                <div id="tired_no_time" class="" style="height: 340px;"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="layui-col-md12">
                        <div class="layui-card">
                            <div class="layui-card-body">
                                <div id="tired_value" class="" style="height: 340px;"></div>
                            </div>
                        </div>
                    </div>
