                    ...
                    <div class="layui-form layui-form-pane" style=" padding: 5px;">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="username" id="name" placeholder="用户姓名" class="layui-input" value="<?php echo ($where_name); ?>">
                            </div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">手机号码</label>
                            <div class="layui-input-inline">
                                <input type="text" name="username" id="phone" placeholder="手机号码" class="layui-input" value="<?php echo ($where_phone); ?>">
                            </div>
                        </div>
                        <div class="layui-inline">
