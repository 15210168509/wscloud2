                ...
                <form class="form-horizontal" id="src_form">
                    <div class="searchTop">
                        ...
                        <div class="layui-col-xs6 layui-col-sm6 layui-col-md6" style="text-align: right">
                            ...
                            <button id="reset_bt" class="layui-btn" >重 置</button>
                        </div>
                    </div>
                    <div class="layui-form layui-form-pane" style=" padding: 5px;">
                        <div class="layui-col-xs6 layui-col-sm6 layui-col-md4">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="username" id="startTime" class="layui-input" readonly value="<?php echo (date('Y-m-d',$where_startTime )); ?>">
                            </div>
                        </div>
                        <div class="layui-col-xs6 layui-col-sm6 layui-col-md4">
                            <label class="layui-form-label">结束时间</label>
                            <div class="layui-input-inline">
                                <input type="text" name="username" id="endTime" class="layui-input" readonly value="<?php echo (date('Y-m-d',$where_endTime )); ?>">
                            </div>
                        </div>
                        <div class="layui-col-xs6 layui-col-sm6 layui-col-md4">
                            ...
                            <div class="layui-input-inline">
                                <select name="city" id="status">
                                    ...
                                    <option value="10" <?php if($where_status == 10): ?>selected="selected"<?php endif; ?>>已读</option>
                                    <option value="20" <?php if($where_status == 20): ?>selected="selected"<?php endif; ?>>未读</option>
                                </select>
                            </div>
                        </div>
