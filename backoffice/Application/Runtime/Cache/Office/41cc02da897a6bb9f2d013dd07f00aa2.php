                    ...
                    <div class="layui-form layui-form-pane" style=" padding: 5px;">
                        <div class="layui-col-xs6 layui-col-sm6 layui-col-md4">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="username" id="name" placeholder="设备名称" class="layui-input" value="<?php echo ($where_name); ?>">
                            </div>
                        </div>
                        <div class="layui-col-xs6 layui-col-sm6 layui-col-md4">
                            <label class="layui-form-label">设备号</label>
                            <div class="layui-input-inline">
                                <input type="text" name="username" id="serialNo" placeholder="设备号" class="layui-input" value="<?php echo ($where_phone); ?>">
                            </div>
                        </div>
