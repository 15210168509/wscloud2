...
return array(
    ...
    'Debug'               => false,
    'TOKEN_TYPE'          => 10,
    'ENV'                 => 'release',//dev 开发模式，release 发布模式
    'ADMIN_TOPIC'         => 'office',
    ...
    'API_GATEWAY_ENV'     => "@API_GATEWAY_ENV@",//API环境，1：测试，2：预发，3：发布
    ...
    //==============MQTT==========================
    'MQTT_HOST'           => '@mqttHost@',//MQTT服务器地址
    'MQTT_HOST_PORT'      => "@mqttPort@",//MQTT服务器地址监听端口
    ...
    //==============模板配置========================
    'MENU'=>array(
        array('id'=>1,'name'=>'系统管理','url'=>'/Monitor/showData','controller'=>array('Index', 'Admin','Device','Vehicle','Driver','Groups','Monitor','RoadLine'),'submenu'=>array(
        ...
        array('id'=>2,'name'=>'设置','url'=>'/Office/System','controller'=>array('System'),'submenu'=>array(
