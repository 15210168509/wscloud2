...
class AdminController extends ListAdminController
{
    ...
    public function add()
    {
        ...
        $this->addJS(array('admin/admin/addAdmin.js'));
    ...
    public function lists()
    {
        ...
        $this->addJS(array('admin/admin/adminList.js'));
    ...
    {
        $para = array('name'=>'string','phone'=>'string','status'=>'int');
    ...
    public function adminDetail($adminId)
    {
        ...
        $this->addJS(array('admin/admin/adminDetail.js'));
        $this->display();
    }
    ...
    public function adminMsg()
    {
        ...
        $this->addJS(array('admin/admin/adminMsgList.js'));
    ...
    public function adminInfo(){
        ...
        $this->addJS('admin/admin/adminInfo.js');
