...
/**
 * 注册表，存储多级数据,可按路径存储，默认路径分隔符为.
 * 例如 error error.system
 */

class Registry implements \JsonSerializable,\ArrayAccess,\IteratorAggregate
{
    ...
    */
     ...
     * 默认定义
    */
    public function def($key,$defaultValue=''){
